            ...
            if (role) {
                ...
                if (confirmThesis === true) {
                    ...
                    if (getThesesByThesisIdResults[0][0].lecturer1_id != null) {
                        ...
                        const sendNotificationSup1Params = [`Lecturer2 accept thesis`, req.userId, getThesesByThesisIdResults[0][0].lecturer1_id, `${getThesesByThesisIdResults[0][0].lecturer2_title} has accepted to join the thesis "${getThesesByThesisIdResults[0][0].thesis_topic}"`];
